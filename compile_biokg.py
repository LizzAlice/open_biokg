...
def compile_graph():
    ...
    write_triples(
        tissue_structure, join(cell_properties_root, "cell_tissue_membership.txt")
    )
    ...
    write_triples(
        indication_triples, join(drug_properties_root, "drug_indications.txt")
    )
    ...
    copy(join(data_root, "medgen", "mim_categories.txt"), mim_properties_root)
    ...
    copy_folder(
        ...
        other_cello,
        included_files=["cl_cat.txt", "cl_geo.txt", "cl_map.txt", "cl_pmid.txt"],
    )
    ...
    copy_folder(
        ...
        other_drugbank,
        included_files=["db_mechanism_or_action.txt", "db_mesh.txt"],
    )

    other_hpa = join(other_root, "hpa")
    makedirs(other_hpa) if not isdir(other_hpa) else None
    copy_folder(
        join(data_root, "hpa"), other_hpa, included_files=["hpa_antibodies.txt"]
    )
    ...
    copy_folder(
        ...
        other_phos,
        included_files=["phosphorylation_site.txt"],
    )
    ...
    copy_folder(
        ...
        other_reactome,
        included_files=["reactome_go_mapping.txt", "reactome_isoform_pathway.txt"],
    )
    ...
    copy_folder(
        ...
        other_sider,
        included_files=["sider_indications_meta.txt", "sider_effects_meta.txt"],
    )
