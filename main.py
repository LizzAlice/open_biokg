...
def preprocess_graph():
    ...
    if len(sys.argv) >= 3:
        ...
        download_drugbank_data(
            sources_dp=sources_dp,
            srcs_cp=sources_urls,
            username=db_user,
            password=db_pass,
        )
    ...
    if invalid_md5:
        ...
        print(
            inf_sym
            + "Uniprot processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    ...
    if invalid_md5:
        ...
        print(
            inf_sym
            + "HPA processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    # ----------------------------------------------------------------------
    ...
    if invalid_md5:
        ...
        if exists(drugbank_source_fp):
            ...
            print(
                fail_sym
                + "Drugbank source not available >>> Skipping Drugbank processing"
            )
    else:
        print(
            inf_sym
            + "DrugBank processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    ...
    if invalid_md5:
        ...
        print(
            inf_sym
            + "MESH processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    ...
    if invalid_md5:
        ...
        print(
            inf_sym
            + "Reactome processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    ...
    if invalid_md5:
        ctd_parser.parse_ctd(
            sources_dp, join(uniprot_dp, "uniprot_metadata.txt"), ctd_dp
        )
        for ofp in ctd_fps:
            export_file_md5(ofp)
    else:
        print(
            inf_sym
            + "CTD processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    ...
    if invalid_md5:
        ...
        print(
            inf_sym
            + "PhosphoSitePlus processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    ...
    if invalid_md5:
        intact_parser.parse_intact(
            sources_dp, intact_dp, join(uniprot_dp, "uniprot_ppi.txt")
        )
        ...
        print(
            inf_sym
            + "Intact processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    ...
    if invalid_md5:
        ...
        print(
            inf_sym
            + "Sider processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    ...
    if invalid_md5:
        ...
        print(
            inf_sym
            + "MedGen processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    ...
    if invalid_md5:
        ...
        print(
            inf_sym
            + "Hijazi20 processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
    ...
    if invalid_md5:
        ...
        print(
            inf_sym
            + "SMPDB processed files exists with valid md5 hashes %s. >>> Parsing not required."
            % done_sym
        )
